...
const Project = ({ img, name, discription, url }) => {
  ...
  return (
    <div
      className="mx-2 sm:mx-5 bg-[#dad0e5] flex-shrink-0 w-auto h-auto xs:h-[90%] md:w-[90%] md:h-full snap-center flex md:flex-row flex-col items-center md:justify-center rounded-lg cursor-pointer overflow-y-scroll no-scrollbar "
    ...
    >
      ...
      <div className="md:w-[35%] h-[80%] md:flex flex-col md:justify-center md:items-center md:mt-5 ">
        ...
        <h1 className=" my-2 sm:my-4 w-44 md:my-7 px-5 text-center text-sm lg:text-xl ">
          {discription}
        </h1>
      </div>
    </div>
